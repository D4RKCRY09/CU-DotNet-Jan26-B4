...
**Title:** Deploy Web API with
EF Core + Azure SQL + MVC Client on Azure
...
3. Create Student model:
   ...
   * Course
     ...
     ![1776225852149](image/Day81/1776225852149.png)
4. Create DbContext

   ![1776225885872](image/Day81/1776225885872.png)
...
2. Create:
   ...
   * Database
   ...
   ![1776226031791](image/Day81/1776226031791.png)
3. Configure:
...
![1776236464529](image/Day81/1776236464529.png)
...
2. Publish API from Visual Studio:
   ...
   * Select Azure → App Service
     ...
     ![1776236541388](image/Day81/1776236541388.png)
3. Configure:
...
2. Create Student ViewModel
   ...
   ![1776236574773](image/Day81/1776236574773.png)
3. Call API using:

   * HttpClient

     ![1776236620070](image/Day81/1776236620070.png)
4. Implement:
