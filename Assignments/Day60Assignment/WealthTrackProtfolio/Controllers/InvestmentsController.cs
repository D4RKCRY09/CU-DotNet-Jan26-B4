...
namespace WealthTrackProtfolio.Controllers
{
    public class InvestmentsController : Controller
    {
        private readonly WealthTrackProtfolioContext _context;

        public InvestmentsController(WealthTrackProtfolioContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create(InvestmentCreateViewModel vm)
        {
            ...
            {
                int i = await _context.Investment.CountAsync();
                var model = new Investment
                {
                    AssetName = $"MyAsset{i+1}",
