...
namespace LoanManagementWebAPI.Controllers
{
    ...
    public class LoansController : ControllerBase
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutLoan(int id, LoanPostDTO loanpost)
        {
            var loan = await _context.Loan.FindAsync(id);
            loan = _mapper.Map(loanpost, loan);
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<Loan>> PostLoan(LoanPostDTO loanpost)
        {
            var loan = _mapper.Map<Loan>(loanpost);
